...
$sel_idmenu =  app('request')->input('sel_idmenu');  
				...
				<div class="col-sm-8">
					...
					<form class="frm_menuhascate" method="post" action="{{ action('Admin\MenuHasCateController@update',$sel_idmenu) }}" >
						...
						<input type="hidden" name="_method" value="PATCH">
			           	<input type="hidden" class="hidden_idmenu" name="hidden_idmenu" value="{{ app('request')->input('sel_idmenu') }}">
						<div class="col-lg-12">
...
@section('other_scripts')
    ...
    <script src="{{ asset('dashboard/production/js/menuhascate2.js?v=0.4.3.2') }}"></script>
@stop