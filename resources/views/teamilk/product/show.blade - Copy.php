...
<div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space">
	...
	<div class="container">
		...
		<div class="c-content-title-4">
			...
			<h3 class="c-font-uppercase c-center c-font-bold c-line-strike"><span class="c-bg-white">combo</span></h3>
							...
							<div class="item">
								...
								<div class="c-content-product-2 c-bg-white c-border">
									...
									<div class="c-info">
										...
										<p class="c-price c-font-16 c-font-slim"><span class="currency">{{ $row['price_combo']}}</span><span class="vnd"></span> &nbsp;
											<span class="c-font-16 c-font-slim">x{{ $row['quality_combo'] }}(buổi)</span>
...
<div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space">
	...
	<div class="container">
		...
		<div class="c-content-title-4">
			...
			<h3 class="c-font-uppercase c-center c-font-bold c-line-strike"><span class="c-bg-white">Quà tặng</span></h3>
							...
							<div class="item">
								...
								<div class="c-content-product-2 c-bg-white c-border">
									...
									<div class="c-info">
										...
										<p class="c-price c-font-16 c-font-slim"><span class="currency">{{ $row['price_gift']}}</span><span class="vnd"></span> &nbsp;
											<span class="c-font-16 c-font-slim">x{{ $row['quality_gift'] }}(buổi)</span>
											{{-- <span class="c-font-16 c-font-line-through c-font-red">@if($row['price_sale_origin'])<span class="currency">{{ $row['price_sale_origin'] }}</span><span class="vnd"></span>@endif</span> --}}
