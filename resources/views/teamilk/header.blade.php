        ...
        <div class="container">
            ...
            <nav class="c-top-menu c-pull-left">
                ...
                <ul class="c-icons c-theme-ul">
                    ...
                    <li class="hide"><span>CSKH: 0967 735 106 </span></li>
            ...
            <div class="c-navbar-wrapper clearfix">
                ...
                <div class="c-brand c-pull-left">
                    ...
                    <a href="{{ url('/') }}" class="c-logo">
                        ...
                        <img src="{{ asset('assets-tea/images/logo/logo-zutheme3.png') }}" alt="JANGO" class="c-desktop-logo">



                        <img src="{{ asset('assets-tea/images/logo/logo-zutheme3.png') }}" alt="JANGO" class="c-desktop-logo-inverse">



                        <img src="{{ asset('assets-tea/images/logo/logo-zutheme3.png') }}" alt="JANGO" class="c-mobile-logo">
